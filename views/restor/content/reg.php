...
<body class='body_vp-1 body_lang-ru body_layerId-162  theme_hasLeftCol'>
	<div id="wrap">					
		...
		<div>
			<h1 class="lite-grey">Регистрация ресторана в системе</h1>
			...
			<table class="Striped">
				<tbody>
					<tr>
						...
						<td>
							<div>
      							<textarea name="name" cols="40" rows="6" class="form-control"></textarea>
    						</div>
						</td>
						<td></td>
					</tr>
					<tr>
						...
						<td>
							<div>
      							<textarea name="face" cols="40" rows="6" class="form-control"></textarea>
    						</div>
						</td>
						<td></td>
					</tr>
					<tr>
						...
						<td>
							<div>
      							<textarea name="inn" cols="40" rows="6" class="form-control"></textarea>
    						</div>
						</td>
						<td></td>
					</tr>
					<tr>
						...
						<td>
							<div>
      							<textarea name="adress" cols="40" rows="6" class="form-control"></textarea>
    						</div>
						</td>
						<td></td>
					</tr>
					<tr>
						...
						<td>
							<div>
      							<textarea name="schet" cols="40" rows="6" class="form-control"></textarea>
    						</div>
						</td>
						<td></td>
					</tr>
					<tr>
						...
						<td>
							<div>
      							<textarea name="bank" cols="40" rows="6" class="form-control"></textarea>
    						</div>
						</td>
						<td></td>
					</tr>
					<tr>
						...
						<td>
							<div>
      							<textarea name="bik" cols="40" rows="6" class="form-control"></textarea>
    						</div>
						</td>
						<td></td>
					</tr>
					<tr>
						...
						<td>
							<div>
      							<textarea name="pochta" cols="40" rows="6" class="form-control"></textarea>
    						</div>
						</td>
						<td></td>
					</tr>
					<tr>
						...
						<td>
							<div>
      							<textarea name="telefon" cols="40" rows="6" class="form-control"></textarea>
    						</div>
						</td>
						<td></td>
					</tr>
					<tr>
						...
						<td>
							<div>
      							<textarea name="email" cols="40" rows="6" class="form-control"></textarea>
    						</div>
						</td>
						<td></td>
					</tr>
					<tr>
						...
						<td>
							<div>
      							<textarea name="password" cols="40" rows="6" class="form-control"></textarea>
    						</div>
						</td>
						<td></td>
					</tr>
					<tr>
						<td></td>
						<td><label for="submitbtn" class="uploadButton">Составить договор</label>
